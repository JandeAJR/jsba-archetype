...
/**
 * Interface: InfrastructureRoleMapper <br>
...
public interface InfrastructureRoleMapper {
	// From Domain To Entity (Role -> RoleEntity)
	RoleEntity toEntityFromDomain(Role role); 
	
	// From Entity To Domain (RoleEntity -> Role)
	Role toDomainFromEntity(RoleEntity roleEntity);
	List<Role> toDomainFromEntityList(List<RoleEntity> roleEntities);
}
