...
/**
 * Interface: InfrastructureUserMapper <br>
...
public interface InfrastructureUserMapper {
	// From Domain To Entity (User -> UserEntity)             
    @Mapping(target = "authorities", ignore = true)     
    @Mapping(source = "roles", target = "roleEntities")
    UserEntity toEntityFromDomain(User user);

    // From Entity To Domain (UserEntity -> User)     
    @Mapping(target = "password", ignore = true) // Não mapear o atributo password quando for retornar os dados do usuário
