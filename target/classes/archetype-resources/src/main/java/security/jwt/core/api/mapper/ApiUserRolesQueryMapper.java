...
/**
 * Interface: ApiUserRolesQueryMapper <br>
...
public interface ApiUserRolesQueryMapper {
	// From Output To DTO (UserRolesQueryOutput -> UserRolesQueryResponse)
	UserRolesQueryResponse toDtoFromApplicationOutput(UserRolesQueryOutput userRolesQueryOutput);
	List<UserRolesQueryResponse> toDtoFromApplicationOutputList(List<UserRolesQueryOutput> userRolesQueryOutput);
}
