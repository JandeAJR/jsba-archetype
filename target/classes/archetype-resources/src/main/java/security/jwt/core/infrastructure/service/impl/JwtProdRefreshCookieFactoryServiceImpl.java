...
public class JwtProdRefreshCookieFactoryServiceImpl implements JwtCookieFactoryService {
	private final JwtProperties jwtProperties;
	
	@Override
	public ResponseCookie create(String cookieName, String cookieValue, Boolean isLogout) {	
		// Retorna o Cookie HttpOnly (para Refresh Token) configurado para ambientes de produção.
